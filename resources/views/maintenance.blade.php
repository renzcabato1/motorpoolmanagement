                        ...
                        <tbody>
                          @foreach($equipments as $equip)
                            <tr>
                                ...
                                <td > 
                                    <button class="btn btn-sm btn-primary repair-equipment"  title='Repair' ><i class="fa fa-check"></i></button>
                                    <button class="btn btn-sm btn-info"  title='View' data-target="#viewData{{$equip->id}}" data-toggle="modal"><i class="fa fa-eye"></i></button>
                                    <button class="btn btn-sm btn-danger for-disposal" title='For Disposal' ><i class="fa fa-trash"></i></button>
                                </td >
                            </tr>
                          @endforeach
                        </tbody>
